...
class BaseHybridSimilarity(BaseItemSimilarityMatrixRecommender):
    ...
    W_sparse_hybrid = recommender_1.W_sparse * alpha + recommender_2.W_sparse * beta
    ...
    def fit(self, topK=1000, alpha=0.80, beta=0.30):

        print('{} hyperparams: topK: {}; alpha: {}; beta: {}'.format(self.RECOMMENDER_NAME, str(topK), alpha, beta))
